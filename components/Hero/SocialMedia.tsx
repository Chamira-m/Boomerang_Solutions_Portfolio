  ...
  return (
    <div className=" 3xl:mt-6 mt-1 flex flex-col p-2 md:mt-2 md:p-3 2xl:mt-5 ">
      <div className="flex w-full">
        <SocialMediaButton
          link="https://www.facebook.com/Torenshal/"
        ...
        />
        <SocialMediaButton
          link="https://x.com/torenshal?s=21&t=60aAmVYPlQbYmk6HAEPD1Q"
          style="4xl:w-[45px] 4xl:h-[45px] 2xl:w-[24px] 2xl:h-[24px] md:w-[18px] md:h-[18px] w-[17px] h-[17px] mr-2 cursor-pointer"
          image="/images/socialmedia/twitter.png"
        />
        <SocialMediaButton
          link="https://www.linkedin.com/company/torenshal"
          style="4xl:w-[45px] 4xl:h-[45px] 2xl:w-[24px] 2xl:h-[24px] md:w-[18px] md:h-[18px] w-[17px] h-[17px] mr-2 cursor-pointer"
          image="/images/socialmedia/linkedin.png"
        />
        <SocialMediaButton
          link="https://www.instagram.com/torenshal.digital/"
          style="4xl:w-[45px] 4xl:h-[45px] 2xl:w-[24px] 2xl:h-[24px] md:w-[18px] md:h-[18px] w-[17px] h-[17px] mr-2 cursor-pointer"
